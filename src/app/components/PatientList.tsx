      ...
      <div className="max-w-[1600px] mx-auto px-12 py-16">
        ...
        >
          <div className="relative">
            ...
            <Input
              ...
              className="pl-8 border-0 border-b border-slate-200 rounded-none focus:border-slate-900 focus:ring-0 text-lg"
            />
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="col-span-2">
            <span className="text-xs uppercase tracking-widest text-slate-500">MRN</span>
          </div>
          <div className="col-span-2">
            <span className="text-xs uppercase tracking-widest text-slate-500">Date of Birth</span>
          </div>
          <div className="col-span-2">
            <span className="text-xs uppercase tracking-widest text-slate-500">Last Visit</span>
          </div>
          <div className="col-span-1">
            <span className="text-xs uppercase tracking-widest text-slate-500">Notes</span>
          </div>
          <div className="col-span-2">
        ...
        <div>
          {filteredPatients.map((patient, index) => (
            <motion.div
              ...
              className="grid grid-cols-12 gap-4 px-8 py-6 border-b border-slate-100 hover:bg-slate-50 transition-colors cursor-pointer group"
            >
              <div className="col-span-3">
              ...
              <div className="col-span-2">
                <span className="text-sm text-slate-600">{patient.dob}</span>
              </div>
              <div className="col-span-2">
                <span className="text-sm text-slate-600">{patient.lastVisit}</span>
              </div>
              <div className="col-span-1">
                <span className="text-sm text-slate-600">{patient.notes}</span>
              </div>
              <div className="col-span-2">
                <span className="text-xs uppercase tracking-wider text-slate-400">{patient.status}</span>
              </div>
            </motion.div>
          ))}
        </div>
