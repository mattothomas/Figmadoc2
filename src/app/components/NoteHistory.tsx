      ...
      <div className="max-w-[1600px] mx-auto px-12 py-16">
        ...
        >
          <div className="col-span-3">
            <span className="text-xs uppercase tracking-widest text-slate-500">Patient</span>
          </div>
          ...
          <div className="col-span-2">
            <span className="text-xs uppercase tracking-widest text-slate-500">Time</span>
          </div>
          <div className="col-span-2">
        ...
        <div>
          {filteredNotes.map((note, index) => (
            ...
            >
              <div className="col-span-3">
                <span className="text-sm font-medium text-slate-900">{note.patient}</span>
              </div>
              <div className="col-span-2">
              ...
              <div className="col-span-2">
                <span className="text-sm font-mono text-slate-500">{note.time}</span>
              </div>
              <div className="col-span-2">
                <span className="text-xs uppercase tracking-wider text-slate-400">{note.status}</span>
              </div>
            </motion.div>
          ))}
        </div>
